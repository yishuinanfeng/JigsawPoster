...
class PathParser {
    ...
    /**
     * @param pathData The string representing a mPath, the same as "d" string in svg file.
    ...
    /**
     * @param nodesFrom The source mPath represented in an array of PathDataNode
     * @param nodesTo   The target mPath represented in an array of PathDataNode
     ...
     *
     * @param target The target mPath represented in an array of PathDataNode
     * @param source The source mPath represented in an array of PathDataNode
     */
    ...
    private static int nextStart(String s, int end) {
        ...
        while (end < s.length()) {
            c = s.charAt(end);
            // Note that 'e' or 'E' are not valid mPath commands, but could be
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current,
            ...
            for (int k = 0; k < val.length; k += incr) {
                switch (cmd) {
                    case 'm': // moveto - Start a new sub-mPath (relative)
                        currentX += val[k + 0];
                        currentY += val[k + 1];
                        if (k > 0) {
                        ...
                        break;
                    case 'M': // moveto - Start a new sub-mPath
                        currentX = val[k + 0];
                        currentY = val[k + 1];
                        if (k > 0) {
                            // According to the spec, if a moveto is followed by multiple
        ...
        private static void drawArc(Path p,
            ...
            /* Pre-compute rotation mMatrix entries */
